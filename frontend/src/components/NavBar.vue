...
<RouterLink class="route" :to="{ name: 'SensorData' }">
    <VBtn class="text-subtitle-2" density="compact" color="primary" :variant="(route.name == 'SensorData')? 'tonal':'text'">Sensor Data</VBtn>
</RouterLink>
